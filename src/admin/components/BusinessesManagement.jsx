...
const BusinessesManagement = () => (
    <div style={{ display: 'grid', gap: '1.5rem' }}>
        {[
            ...
            <div key={i} style={{ padding: '2rem', background: 'var(--dark-2)', borderRadius: '0', border: '1px solid var(--border)', display: 'flex', alignItems: 'center', gap: '2rem' }}>
                <div style={{ width: '64px', height: '64px', background: 'var(--dark)', borderRadius: '0', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.5rem', fontWeight: 800, border: '1px solid var(--border)' }}>{biz.logo}</div>
                <div style={{ flex: 1 }}>
        ...
        <div style={{ padding: '2.5rem', background: 'var(--dark-2)', borderRadius: '0', border: '2px dashed var(--border)', marginTop: '2rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }} className="about-grid">
                <div>
                    ...
                    <input style={{ width: '100%', padding: '1rem', background: 'var(--dark)', border: '1px solid var(--border)', color: 'var(--white)', borderRadius: '0' }} placeholder="e.g. Steak & Stone" />
                </div>
                <div>
                    ...
                    <input style={{ width: '100%', padding: '1rem', background: 'var(--dark)', border: '1px solid var(--border)', color: 'var(--white)', borderRadius: '0' }} placeholder="https://..." />
                </div>
                <div style={{ gridColumn: 'span 2' }}>
                    <div style={{ height: '100px', borderRadius: '0', border: '1px solid var(--border)', background: 'var(--dark)', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer' }}>
